...
game-verified Production poolのcandidate別上限（実ゲーム仕様、[RNG_REFERENCE_AUDIT.md](./RNG_REFERENCE_AUDIT.md) 5.3 / 14.13）。

| candidate | reference lottery ID | 上限 |
|---|---:|---:|
| 基礎攻撃力強化（Attack） | 6 | 5 |
| 属性強化（Element） | 4 | 4 |
| 斬れ味強化 / 装填数強化（family 7） | 7 | 2 |
| 会心率強化（Affinity） | 8 | 3 |
